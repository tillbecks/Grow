...
<html>
    ...
    <body>
        <div style="height: 100%; max-width: 2000px; width: 2000px; display:flex; flex-direction: column; gap: 20px; align-items: center; justify-content: center; padding: 20px;">
            <div style="gap: 20px; shrink: 1; overflow: hidden;">
                <img src="assets/img/GrowLogo.png" alt="Grow Logo" style="max-height: 200px;">
            </div>
            <div style="display:flex; max-height: 100%;gap: 20px; width: 100%; align-items:center; justify-content: center;padding: 20px; flex-shrink: 0;">
                <div style="flex: 50%; display:flex; flex-direction:column; gap: 20px; height: 100%; max-height: 100%; max-width: 50%; width: 825px; shrink: 1; justify-content: center; padding: 10px; border: 2px solid red;">
                    <div style="overflow: auto; shrink:1; ">  
                        <div style="min-height: fit-content; height: fit-content; min-width: fit-content;  display:flex;  justify-content: flex-end; align-items: center;">                  
                            <canvas id="canvas" width="800" height="600" ></canvas>
                        </div>
                    </div>
                    <div style="flex-shrink: 0; display:flex; gap: 2px; justify-content: space-between; align-items: center;">
                        <div style="shrink: 1; display:flex; gap: 2px; overflow:auto;">
            ...
            <div style="gap: 20px; shrink: 1; overflow: hidden; display:flex; justify-content: center; align-items: center;">
                <div style="border: 2px solid white; padding: 10px; width: 600px; height: 5px;">
                    Test
                </div>                
            </div>
        </div>
